...
h1.innerHTML = "<code> Titulo de mi H1</code>";

// agregando Elementos (Nodos)

var cajaVacia = document.getElementById("cajavacia");

// createElement nos permite crear un nuevo elemnto HTML

var nuevoParrafo = document.createElement("p");

nuevoParrafo.innerHTML = "Hola soy un nuevo Parrafo";

cajaVacia.appendChild(nuevoParrafo);

// crea un nuevo element <img>
